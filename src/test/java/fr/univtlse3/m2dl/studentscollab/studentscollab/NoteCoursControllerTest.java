...
public class NoteCoursControllerTest {
    ...
    public void testPageNouvelleNote() throws Exception {
        this.mockMvc.perform(get("/api/v1/cours/new")).andExpect(status().isOk())
    ...
    public void testPageNoteLike() throws Exception {
        ...
        this.mockMvc.perform(get("/api/v1/cours/like", nc, etu)).andExpect(status().isOk()).andExpect(content().string(containsString("nbLike: 1")));
    }
    ...
    public void testPageNoteDislike() throws Exception {
        ...
        this.mockMvc.perform(get("/api/v1/cours/dislike", nc, etu)).andExpect(status().isOk()).andExpect(content().string(containsString("nbDislike: 1")));
    }
}
